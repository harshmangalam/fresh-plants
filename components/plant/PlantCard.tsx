  ...
  return (
    <article className={tw`bg-white border shadow rounded-lg `}>
      ...
      <div className={tw`px-2 py-4`}>
        ...
        <a href={`/${_id}`}>
          <h3 className={tw`truncate text-gray-600 text-lg font-medium`}>
            {name}
          </h3>
        </a>
        <button
          className={tw`mt-4 bg-blue-400 text-white font-bold w-full px-4 py-2 rounded-md focus:outline-none hover:bg-blue-500`}
        >
          Add to cart
        </button>
      </div>
